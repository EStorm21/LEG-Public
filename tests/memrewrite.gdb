...
Reading symbols from /home/pi/ARM/tests/memrewrite...done.
(gdb) Breakpoint 1 at 0x844c: file memrewrite.s, line 59.
(gdb) Starting program: /home/pi/ARM/tests/memrewrite 

Breakpoint 1, end () at memrewrite.s:59
59	end:    b end
(gdb) r0             0x0	0
r1             0x0	0
r2             0x0	0
...
A debugging session is active.
	...
	Inferior 1 [process 25504] will be killed.
